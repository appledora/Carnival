...
<body>
	...
	<div class="simpleslide100">
		<div class="simpleslide100-item bg-img1" style="background-image: url('images/brain.jpg');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('images/sphere.jpg');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('images/fusion.jpg');"></div>
		{{--<div class="simpleslide100-item bg-img1" style="background-image: url('/resources/images/bg04.jpg');"></div>--}}
	</div>
